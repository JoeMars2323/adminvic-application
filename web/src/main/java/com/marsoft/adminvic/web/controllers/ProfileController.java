...
public class ProfileController {
	...
	public AdminVicResponse<ProfileSolr> getProfileById(@PathVariable Long id) throws AdminVicException {
	...
	public AdminVicResponse<List<ProfileSolr>> getAllProfiles() throws AdminVicException {
		return new AdminVicResponse<>(RestConstants.SUCCESS, String.valueOf(HttpStatus.OK), RestConstants.OK,
	...
	public AdminVicResponse<ProfileSolr> createProfile(@RequestBody ProfileSolr profileRest) throws AdminVicException {
		return new AdminVicResponse<>(RestConstants.SUCCESS, String.valueOf(HttpStatus.OK), RestConstants.OK,
	...
	public AdminVicResponse<ProfileSolr> updateProfile(@RequestBody ProfileSolr profileRest) throws AdminVicException {
		return new AdminVicResponse<>(RestConstants.SUCCESS, String.valueOf(HttpStatus.OK), RestConstants.OK,
	...
	public AdminVicResponse<ProfileSolr> deleteProfile(@PathVariable Long id) throws AdminVicException {
		return new AdminVicResponse<>(RestConstants.SUCCESS, String.valueOf(HttpStatus.OK), RestConstants.OK,
	...
	public AdminVicResponse<ProfileSolr> deleteProfilePhysically(@PathVariable Long id) throws AdminVicException {
		return new AdminVicResponse<>(RestConstants.SUCCESS, String.valueOf(HttpStatus.OK), RestConstants.OK,
